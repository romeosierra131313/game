...
public class overworld {
       ...
       public HashMap<Vector2,String> townlocations = new HashMap();   
       ...
       maki = new Maki();
       maki.setuptown();
       townlocations.put(maki.townxy,maki.name);
       ...
       jinku = new Jinku();
       jinku.setuptown();
       townlocations.put(jinku.townxy,jinku.name);
       townrec.add(1, jinku.r);
       
       testtown1 = new testtown1();
       testtown1.setuptown();
       townlocations.put(testtown1.townxy, testtown1.name);
       townrec.add(2,testtown1.r);
       
       ttown2 = new ttown2();
       ttown2.setuptown();
       townlocations.put(ttown2.townxy, ttown2.name);
       townrec.add(2,ttown2.r);
       
       ttown3 = new ttown3();
       ttown3.setuptown();
       townlocations.put(ttown3.townxy, ttown3.name);
       townrec.add(2,ttown3.r);
       
       ttown4 = new ttown4();
       ttown4.setuptown();
       townlocations.put(ttown4.townxy, ttown4.name);
